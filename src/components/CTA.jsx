        ...
        <div className="relative rounded-3xl border border-gray-200 bg-gradient-to-br from-gray-900 to-black px-10 py-16 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-10 flex justify-center gap-4 flex-wrap">
              ...
              {/* Primary */}
              <button className="bg-white text-black px-7 py-3 rounded-xl text-sm font-semibold hover:bg-gray-200 transition shadow-lg">
                Request Access
              </button>

              {/* Secondary */}
              <button className="border border-white/30 text-white px-7 py-3 rounded-xl text-sm font-medium hover:border-white transition">
                Learn More
              </button>
