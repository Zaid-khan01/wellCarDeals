...
const Contact = () => {
    ...
    const locationLink = "https://www.google.com/maps?q=28.617417,77.077667";
        ...
        <div className="bg-white text-gray-900">
            ...
            <section className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-8 mb-20">
                ...
                {[
                    ...
                    >
                        <div className="w-14 h-14 mx-auto flex items-center justify-center rounded-xl bg-gray-100 text-gray-800 group-hover:bg-black group-hover:text-white transition mb-5">
                            {item.icon}
                        </div>
                        ...
                        {item.link ? (
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="text-gray-500 text-sm mt-2 block hover:text-black transition"
                            >
                                {item.value}
                            </a>
                        ) : (
                    ...
                    <div className="bg-white border border-gray-200 rounded-3xl p-10 shadow-xl">
                        ...
                        <form className="grid md:grid-cols-2 gap-6">
                            ...
                            <input
                                ...
                                className="p-4 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-black/20 transition"
                            />
                            ...
                            <input
                                ...
                                className="p-4 rounded-xl border border-gray-200 md:col-span-2 focus:outline-none focus:ring-2 focus:ring-black/20"
                            />
                            ...
                            <button
                                type="submit"
                                className="md:col-span-2 bg-black text-white py-4 rounded-xl font-medium hover:bg-gray-800 transition shadow-lg hover:shadow-xl"
                            >
                                Send Message
                            </button>
